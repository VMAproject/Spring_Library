jQuery.iUtil = {
    getPosition: function (g) {
        ...
        return {t: d, l: b, w: a, h: f, iw: c, ih: g}
        ...
        if (d) {
            return {t: parseInt(f) || 0, r: parseInt(h) || 0, b: parseInt(a) || 0, l: parseInt(c)}
        } else {
            return {t: f, r: h, b: a, l: c}
        }
        ...
        if (d) {
            return {t: parseInt(f) || 0, r: parseInt(h) || 0, b: parseInt(a) || 0, l: parseInt(c) || 0}
        } else {
            return {t: f, r: h, b: a, l: c}
        }
        ...
        jQuery.iUtil.traverseDOM(a, function (c) {
            for (var b in c) {
        ...
        if (!c || c == "horizontally") {
            jQuery(d).css({left: a.l + ((Math.max(a.w, a.iw) - a.l - b.wb) / 2) + "px"})
        }
    }, fixPNG: function (b, d) {
        var a = jQuery('img[@src*="png"]', b || document), c;
        a.each(function () {
            c = this.src;
            this.src = d;
...
jQuery.iFisheye = {
    build: function (a) {
        return this.each(function () {
            ...
            jQuery.iFisheye.positionItems(b);
            b.fisheyeCfg.items.bind("mouseover", function () {
            ...
            jQuery(document).bind("mousemove", function (f) {
